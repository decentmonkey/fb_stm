...
label basement_bedroom2_teleport:
    if EP1==True:
        jump basement_bedroom2_teleport_EP1
...
label basement_bedroom2_environment:
    if EP1==True:
        jump basement_bedroom2_environment_EP1
    if obj_name == "Monica":
...
label basement_bedroom2_teleport_EP1:
    if obj_name == "Teleport_Bedroom1":
...
label basement_bedroom2_environment_EP1:
    if obj_name == "Monica":
