...
label hostel_edge_1_b_environment:
    if EP1==True:
        jump hostel_edge_1_b_environment_EP1
    if obj_name == "Monica":
        pass
...
label hostel_edge_1_b_teleport_EP1:
    if obj_name == "Teleport_Hostel_1_c":
        if cloth_type == "Nude":
    ...
    if obj_name == "Teleport_Hostel_1_a":
        ...
        return
    return
label hostel_edge_1_b_environment_EP1:
    if obj_name == "Monica":
