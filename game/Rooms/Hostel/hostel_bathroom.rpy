...
label hostel_bathroom_teleport():
    if EP1==True:
        jump hostel_bathroom_teleport_EP1
...
label hostel_bathroom_environment():
    if EP1==True:
        jump hostel_bathroom_environment_EP1
    if obj_name == "Monica":
...
label hostel_bathroom_teleport_EP1:
    if obj_name == "Teleport_Hostel_Bedroom":
    ...
    return
label hostel_bathroom_environment_EP1:
    if obj_name == "Monica":
        mt "Какое жуткое место!"
        return
