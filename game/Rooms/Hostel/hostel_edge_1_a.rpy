...
label hostel_edge_1_a_teleport:
    if EP1==True:
        jump hostel_edge_1_a_teleport_EP1
...
label hostel_edge_1_a_environment:
    if EP1==True:
        jump hostel_edge_1_a_environment_EP1
    if obj_name == "Monica":
        pass
...
label hostel_edge_1_a_teleport_EP1:
    if obj_name == "Teleport_Hostel_1_c":
        if cloth_type == "Nude":
    ...
    if obj_name == "Teleport_Hostel_1_b":
        ...
        return
    return
label hostel_edge_1_a_environment_EP1:
    if obj_name == "Monica":
