...
label hostel_edge_1_c_teleport:
    if EP1==True:
        jump hostel_edge_1_c_teleport_EP1
...
label hostel_edge_1_c_environment:
    if EP1==True:
        jump hostel_edge_1_c_environment_EP1
    if obj_name == "Monica":
        pass
...
label hostel_edge_1_c_teleport_EP1:
    if obj_name == "Teleport_Hostel_Street":
        if cloth_type == "Nude":
    ...
    if obj_name == "Teleport_Hostel_1_a":
        ...
        if act == "w":
            ...
            return
    return
label hostel_edge_1_c_environment_EP1:
    if obj_name == "Monica":
        if gameStage == 3 and gameSubStage == 0:
