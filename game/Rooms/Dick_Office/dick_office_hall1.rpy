...
label dick_office_hall1_teleport:
    if EP1==True:
        jump dick_office_hall1_teleport_EP1
...
label dick_office_hall1_environment:
    if EP1==True:
        jump dick_office_hall1_environment
    if obj_name == "Monica":
        mt "Галстук..."
        mt "(хмык)"
        return
...
label dick_office_hall1_teleport_EP1:
    if obj_name == "Teleport_Entrance":
    ...
    if obj_name == "Teleport_Secretary":
        ...
        return
    return
label dick_office_hall1_environment_EP1:
    if obj_name == "Monica":
