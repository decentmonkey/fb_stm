...
label cloth_shop_view1_teleport_EP1:
...
label cloth_shop_view1_environment_EP1:
...
label cloth_shop_view2_EP1:
    ...
    return
label cloth_shop_view2_teleport_EP1:
    ...
    if obj_name == "Teleport_Cashier":
        ...
        return
    return
label cloth_shop_view2_environment_EP1:
    if obj_name == "Pouf1":
...
label cloth_shop_cashier_EP1:
    ...
    return
label cloth_shop_cashier_teleport_EP1:
    if obj_name == "Teleport_Cloth_Shop_View1":
    ...
    return
label cloth_shop_cashier_environment_EP1:
...
label cloth_shop_dressing_room_EP1:
...
label cloth_shop_dressing_room_spawn1:
    ...
    return
label cloth_shop_dressing_room_teleport_EP1:
    if obj_name == "Teleport_Cloth_Shop_View1":
        if eveningDressFitted == False and dressFitOwnDressDressedOut == True:
    ...
    return
label cloth_shop_dressing_room_environment_EP1:
    if obj_name == "Monica":
        if eveningDressFitted == True:
            mt "Надо же!
...
label cloth_shop_dressing_room2_EP1:
    ...
    return
label cloth_shop_dressing_room2_teleport_EP1:
    if obj_name == "Teleport_Dressing_Room":
        ...
        return
    return
label cloth_shop_dressing_room2_environment_EP1:
    if obj_name == "Dress":
        if obj_data["action"] == "l":
            m "Хм... Мое платье."
...
label cloth_shop_dressing_room3_EP1:
    ...
    return
label cloth_shop_dressing_room3_teleport_EP1:
    if obj_name == "Teleport_Dressing_Room":
        ...
        return
    return
label cloth_shop_dressing_room3_environment_EP1:
    if obj_name == "Monica":
