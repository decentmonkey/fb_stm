...
label gas_station_view1_teleport:
    if EP1==True:
        jump gas_station_view1_teleport_EP1
...
label gas_station_view1_environment:
    if EP1==True:
        jump gas_station_view1_environment_EP1
...
label gas_station_view2_environment:
    if EP1==True:
        jump gas_station_view2_environment_EP1
    if obj_name == "Water":
...
label gas_station_view3_environment:
    if EP1==True:
        jump gas_station_view3_environment_EP1
    if obj_name == "Cakes1":
...
label gas_station_view4_environment:
    if EP1==True:
        jump gas_station_view4_environment_EP1
...
label gas_station_view5_environment:
    if EP1==True:
        jump gas_station_view5_environment_EP1
    if obj_name == "Sofa":
...
label gas_station_view6_teleport:
    if EP1==True:
        jump gas_station_view6_teleport_EP1
...
label gas_station_view6_environment:
    if EP1==True:
        jump gas_station_view6_environment_EP1
    if obj_name == "Bottle2":
        if obj_data["action"] == "l":
            "О. Chateau Lafleur.
            Я люблю это вино!"
...
label gas_station_view_cashier:
    if EP1==True:
        jump gas_station_view_cashier_EP1
...
label gas_station_view_cashier_teleport:
    if EP1==True:
        jump gas_station_view_cashier_teleport_EP1
    if obj_name == "Teleport_Gas_Station_View5":
...
label gas_station_view_cashier_environment:
    if EP1==True:
        jump gas_station_view_cashier_environment_EP1
    if obj_name == "SalesWoman":
        if obj_data["action"] == "l":
...
label gas_station_view_door:
    if EP1==True:
        jump gas_station_view_door_EP1
...
label gas_station_view_door_environment:
    if EP1==True:
        jump gas_station_view_door_environment_EP1
...
label gas_station_view1_teleport_EP1:
    if obj_name == "Teleport_Street_Gas_Station":
        call change_scene("street_gas_station") from _call_change_scene_55
        return
    if obj_name == "Teleport_Gas_Station_View1":
    ...
    return
label gas_station_view1_environment_EP1:
    if obj_name == "SalesWoman":
        if obj_data["action"] == "l":
            if gasStationSaleswomanMischiefed == True and gasStationMonicaLied == True:
                m "А, это та жалкая кассирша?"
...
label gas_station_view2_environment_EP1:
    if obj_name == "Water":
        m "Здесь можно попить воды...
        Наверняка невкусной!"
        return
...
label gas_station_view3_environment_EP1:
    if obj_name == "Cakes1":
        m "Чем эти ватрушки политы?
        Шоколадом?"
    if obj_name == "Cakes2" or obj_name == "Cakes4":
...
label gas_station_view4_environment_EP1:
    if obj_name == "Far_Counter":
        m "Там вдалеке еще стеллаж с алкоголем.
        Мне не видно отсюда..."
        return
...
label gas_station_view5_environment_EP1:
    if obj_name == "Sofa":
        m "Какой-то дешевый диван, такой же дешевый как и заправка!"
    if obj_name == "Left_Counter":
        if obj_data["action"] == "l":
...
label gas_station_view6_teleport_EP1:
    if obj_name == "Teleport_Gas_Station_View5":
        call change_scene("gas_station_view5") from _call_change_scene_65
        return

label gas_station_view6_environment_EP1:
    if obj_name == "Bottle1":
        m "А это виски!"
...
label gas_station_view_cashier_EP1:
    $ print "enter_gas_station_view_cashier"
    $ miniMapData = []
...
label gas_station_view_cashier_teleport_EP1:
    if obj_name == "Teleport_Gas_Station_View5":
        call change_scene("gas_station_view5") from _call_change_scene_67
        return

label gas_station_view_cashier_environment_EP1:
    if obj_name == "SalesWoman":
        if obj_data["action"] == "l":
            if gasStationSaleswomanMischiefed == True and gasStationMonicaLied == True:
                m "А, это та жалкая кассирша?"
...
label gas_station_view_door_EP1:
    $ print "enter_gas_station_view_door"
    $ miniMapData = []
    ...
    return
label gas_station_view_door_environment_EP1:
    if obj_name == "Teleport_Gas_Station_View_Cashier":
