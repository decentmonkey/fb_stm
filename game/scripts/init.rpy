...
label define_autorun_EP1:
    ...
    call define_hudpresets_EP1() from _call_define_hudpresets_EP1

    $ calendar_days = [t_("Пн"), t_("Вт"), t_("Ср"), t_("Чт"), t_("Пт"), t_("Сб"), t_("Вс")]
    return

label define_hudpresets_EP1:
    $ hud_presets = {
        "default" : {
            "display_daytime" : True,
            "display_money" : True,
...
#    $ print(config.keymap)
    ...
    call define_autorun_EP1() from _call_define_autorun_EP1
