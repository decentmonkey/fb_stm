...
label EP1_dick_meeting1_restaurant_init:
...
label EP1_dick_meeting1_restaurant_drive_dialogue1:
    ...
    menu:
        "Это ты виноват!":
            ...
            call EP1_bitch(1, "dickDriveRestaurantOffended1")
    ...
    $ EP1_autorun_to_object("street_rich_hotel", "dick_waiting_monica_dialogue2")
    return
...
label EP1_dick_waiting_monica_dialogue2Short:
    imgr Dick1
    dick "Дорогая!
    Пойдем внутрь скорее!"
    return

label EP1_dick_meeting1_restaurant_reception_dialogue:
...
label EP1_dick_meeting1_restaurant_enter1:
...
#    waitress "Пожалуйста, присаживайтесь."
    $ EP1_autorun_to_object("rich_hotel_restaurant", "dick_meeting1_restaurant_enter1_letsit")
    return

label EP1_dick_meeting1_restaurant_enter1_letsit:
    waitress "Пожалуйста, присаживайтесь."
    return

label EP1_dick_meeting1_restaurant_monica_interaction(obj_data):
...
label EP1_dick_meeting1_restaurant_dick_interaction(obj_data):
        ...
        if richHotelRestaurantDickOffended1ChoiceMade == False:
            ...
            menu:
                "Сказать Дику что он смешной.":
                    ...
                    "Это очень смешно!"
                    call EP1_bitch(5, "richHotelRestaurantDickOffended1")
                    if richHotelRestaurantState == 1:
                        img 1423
                    if richHotelRestaurantState == 2:
                        img 1428
                ...
                "Промолчать, это уже будет слишком.":
                    ...
                    call EP1_bitch(-3, "richHotelRestaurantDickOffended1")
        else:
    ...
    if obj_data["action"] == "t":
        if richHotelRestaurantState == 1:
            call EP1_dick_meeting1_restaurant_dialogue1()
            return
        if richHotelRestaurantState == 2:
            call EP1_dick_meeting1_restaurant_dialogue2()
            return
        if richHotelRestaurantState == 3:
            dick "Моника! Я... Эээээ..."
            return
...
label EP1_dick_meeting1_restaurant_waitress_interaction(obj_data):
    if obj_data["action"] == "l":
        if richHotelRestaurantState == 3:
            if bitchmeterValue > maxBitchness / 2:
    ...
    if obj_data["action"] == "t":
        if richHotelRestaurantState == 1:
            ...
            return
        if richHotelRestaurantState == 3:
            call EP1_dick_meeting1_restaurant_dialogue4_waitress_b()
    return


label EP1_dick_meeting1_restaurant_dialogue1():
    img 1409
    with fade
...
label EP1_dick_meeting1_restaurant_dialogue2():
    img 1412
    with fadelong
    m "..."
    ...
    label EP1_dick_meeting1_restaurant_dialogue2_menu_loop1:
    menu:
        "Мой сосед...":
            call EP1_dick_meeting1_restaurant_dialogue2_neighbor()
            call EP1_refresh_scene_fade()
            return
        "Ферма соседа..." if dick_meeting1_restaurant_dialogue1_completed == True and neighborOffendedFarm == True and neighborOffendedSue == True:
            call EP1_dick_meeting1_restaurant_dialogue2_neighbor_d_farm()
            call EP1_refresh_scene_fade()
            return
        "Ферма соседа... (disabled)" if dick_meeting1_restaurant_dialogue1_completed == True and neighborOffendedFarm == False and neighborOffendedSue == True:
            jump EP1_dick_meeting1_restaurant_dialogue2_menu_loop1

        "Моя служанка...":
            call EP1_dick_meeting1_restaurant_dialogue2_julia()
            call EP1_refresh_scene_fade()
            return

        "Модели...":
            call EP1_dick_meeting1_restaurant_dialogue3_models()
            call EP1_refresh_scene_fade()
            return
...
#        "Где там наш ужин?" if dick_meeting1_restaurant_dialogue1_completed == True and dick_meeting1_restaurant_dialogue2_completed == True and dick_meeting1_restaurant_dialogue3_completed == True:
        "Где там наш ужин?" if dick_meeting1_restaurant_dialogue1_completed == True:
            ...
            $ EP1_autorun_to_object("rich_hotel_restaurant", "dick_meeting1_restaurant_dialogue4_waitress")
...
label EP1_dick_meeting1_restaurant_dialogue2_neighbor():
...
#    $ houseStreetFenceLocationOpened = True #debug
    ...
    label EP1_dick_meeting1_restaurant_dialogue2_neighbor_menu_loop1:
    menu:
        "Да, я видела его, Дик!" if houseStreetFenceLocationOpened == True :
            jump EP1_dick_meeting1_restaurant_dialogue2_neighbor_a

        "Да, я видела его, Дик! (disabled)" if houseStreetFenceLocationOpened == False:
            jump EP1_dick_meeting1_restaurant_dialogue2_neighbor_menu_loop1
...
label EP1_dick_meeting1_restaurant_dialogue2_neighbor_a():

    img 1418
    m "Да, я видела его, Дик!"
    label EP1_dick_meeting1_restaurant_dialogue2_neighbor_a_menu_loop1:
    menu:
        ...
        "Это какой-то бедняк. (disabled)" if neighborOffended1 == False:
            jump EP1_dick_meeting1_restaurant_dialogue2_neighbor_a_menu_loop1
    ...
    label EP1_dick_meeting1_restaurant_dialogue2_neighbor_a_menu_loop2:
    menu:
        ...
        "Этот придурок чуть не погиб! (disabled)" if neighborOffended2 == False:
            jump EP1_dick_meeting1_restaurant_dialogue2_neighbor_a_menu_loop2
...
label EP1_dick_meeting1_restaurant_dialogue2_neighbor_b():
    img 1416
...
label EP1_dick_meeting1_restaurant_dialogue2_neighbor_c():
...
#    $ neighborOffendedSueBig = True #debug
    label EP1_dick_meeting1_restaurant_dialogue2_neighbor_c_menu_loop1:
    menu:
        ...
        "$100.000, Дик! (disabled)" if neighborOffendedSueBig == False:
            jump EP1_dick_meeting1_restaurant_dialogue2_neighbor_c_menu_loop1
...
label EP1_dick_meeting1_restaurant_dialogue2_neighbor_d_farm():
    img 1418
    m "Да, кстати, Дик!
    Я совсем забыла!"
    img 1412
...
label EP1_dick_meeting1_restaurant_dialogue2_julia():
    ...
    label EP1_dick_meeting1_restaurant_dialogue2_julia_menu_loop1:
    menu:
        ...
        "Я это пережила. (disabled)" if juliaMonicaLied == True:
            jump EP1_dick_meeting1_restaurant_dialogue2_julia_menu_loop1
...
label EP1_dick_meeting1_restaurant_dialogue3_models():
    $ dick_meeting1_restaurant_dialogue3_completed = True

#    $ monkeysOffended3 = True #debug
    label EP1_dick_meeting1_restaurant_dialogue3_models_menu_loop1:
    menu:
        ...
        "Сегодня был забавный случай... (disabled)" if monkeysOffended3 == False:
            jump EP1_dick_meeting1_restaurant_dialogue3_models_menu_loop1
...
label EP1_dick_meeting1_restaurant_dialogue4_waitress_b():
    label EP1_dick_meeting1_restaurant_dialogue4_waitress_b_menu_loop1:
    menu:
        "Меня утомила эта стерва." if bitchmeterValue > maxBitchness / 2:
            music casualMusic
            img 1422
            m "Дик."
            call EP1_bitch(3, "waitressMonicaOffended1")
            ...
            menu:
                "Уволь эту дуру.":
                    ...
                    dick "Да, дорогая."
                    img 1433
                    call EP1_bitch(5, "waitressMonicaFired")
        ...
        "Меня утомила эта стерва. (Моника слишком добрая) (disabled)" if bitchmeterValue < maxBitchness / 2:
            jump EP1_dick_meeting1_restaurant_dialogue4_waitress_b_menu_loop1
        "Уже правда поздно?" if bitchmeterValue < maxBitchness / 2:
            ...
            menu:
                "Оставить чаевые...":
                    ...
                    dick "Нет, Моника!
                    Конечно нет!"
                    call EP1_bitch(-5, "waitressMonicaTips")
    ...
    $ EP1_autorun_to_object("street_rich_hotel", "dick_meeting1_car_parting1")
    call EP1_change_scene("rich_hotel_reception", "Fade_long")
    return
