label EP1_dick_meeting1_car_parting1:
...
label EP1_dick_meeting1_car_parting2:
    call EP1_get_to_drive_dialogue_return_result()
    if _return == False:
        return
    ...
    menu:
        "Выбросить его прямо здесь...":
            sound snd_car_engine
            call EP1_bitch(5, "dickCarKickedOut")
        ...
        "Отвезти к офису...":
            sound snd_car_engine
            call EP1_bitch(-2, "dickCarKickedOut")
            img 1439
            m "Дик, ты правда думаешь что я буду тратить время чтобы отвозить тебя домой?"
            img 1438
            dick "Дорогая, я бы тебе показал где я живу и..."
            ...
            call EP1_process_change_map_location("Dick_Office")
            $ EP1_autorun_to_object("street_dick_office", "dick_meeting1_car_parting3")
            call EP1_change_scene("street_dick_office", "Fade_long", "snd_car_engine")
    return

label EP1_dick_meeting1_car_parting3:
    imgr Dick5
...
label EP1_dick_meeting1_car_parting4_fred_dialogue(target_scene):
    sound snd_car_engine
    imgl 1440
    m "Дик..."
    menu:
        "Дик жирный урод!":
            ...
            call EP1_bitch(2, "dickMonicaSaidToFredOffend")
    ...
    $ driverMode = 1
    $ EP1_autorun_to_object("street_house_main_yard", "monica_fred_day1_evening_dialogue")
    call EP1_quest_house_monica_day1_evening_init()
    return
