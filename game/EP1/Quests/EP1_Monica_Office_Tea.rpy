label EP1_monica_office_tea_drive1(target_scene):
    ...
    menu:
        "Надоели эти пешеходы!":
            call EP1_bitch(1, "monica_office_tea_drive1")
            ...
            call EP1_bitch(1, "monica_office_tea_drive2")
...
label EP1_monica_office_tea_enter_secretary:
    $ remove_inventory("phone", 1)
#    $ add_inventory("phone", 1, True)
    return

label EP1_monica_office_tea_talk1:
#    $ add_objective("goto_office_for_tea", t_("Ехать в свой офис"), c_green, 20)
    ...
    $ EP1_autorun_to_object("monica_office_cabinet_table", "monica_office_tea_talk2")
    return

label EP1_monica_office_tea_talk2:
    music RnB4_100
    img 1835
    with fadelong
    ...
    call EP1_question_helper_enable("question_office_tea_lost_phone")
...
label EP1_monica_office_tea_phone(obj_name, obj_data):
    ...
    if obj_data["action"] == "h":
        ...
        $ EP1_autorun_to_object("monica_office_entrance", "monica_office_tea_phone_talk_after_found")
        $ EP1_autorun_to_object("monica_office_secretary", "monica_office_tea_secretary_searching_phone")
...
label EP1_monica_office_tea_phone_talk_after_found:
    img 1865
    with fadelong
