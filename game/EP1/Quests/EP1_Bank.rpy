...
#    $ add_objective("goto_bank1", t_("Ехать в Банк по вопросу денег от Стива"), c_red, 20)
    ...
    menu:
        "ВЫ ОБНАГЛЕЛИ В КОНЕЦ!":
            ...
            img 1674
            w
            $ EP1_autorun_to_object("bank_office", "bank_office_thinking1")
...
label EP1_bank_office_thinking1:
...
label EP1_bank_office_talk2_not_offended:
    img 1652
    with fade
    bank_clerk "Добрый день, Мэм!"
    "Чем могу Вам помочь?"
