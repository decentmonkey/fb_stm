label EP1_afterJailFredDialogue:
    $ renpy.pause(2.0)
...
label EP1_afterJailFredDialogue2:
    $ renpy.music.set_pause(True, "rain")
    $ rain = False
    music Groove2_85
    imgr Driver_Stand
...
label EP1_afterJailFredDialogue_discardlocation(o,d):
    fred "Мы едем к дому или Вы можете быть свободны."
    return

label EP1_afterJailFredDialogue3:
    img black_screen
    with Dissolve(0.5)
...
#    music snd_moderate_rain_music
    ...
    label EP1_afterJailFredDialogue3_menu_loop1:
        img 3250
        menu:
            "Я не хочу и не буду делать этого, Фред!":
                ...
                "Попрошу Вас выйти, я тороплюсь!"
                mt "О БОЖЕ!!!"
                jump EP1_afterJailFredDialogue3_menu_loop1
...
#    $ rainIntencity = 3
    ...
    $ EP1_autorun_to_object("street_house_main_yard", "EP1_afterJailHouseFamily_dialogue0")
