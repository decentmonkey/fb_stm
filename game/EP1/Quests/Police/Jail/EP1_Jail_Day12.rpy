label EP1_jail_day12:
    ...
    call EP1_textonblack(t_("ДЕНЬ 12"))
    img black_screen
    with Dissolve(1)
    music Jail_Clock
...
label EP1_jail_day12_Monica(obj_name, obj_data):
...
label EP1_jail_day12_Bed(obj_name, obj_data):
    if act == "l":
...
label EP1_jail_day12_Cage(obj_name, obj_data):
    if act == "l":
...
label EP1_jail_day12_Cage_Interact:
    music Groove2_85
    img 2495
    with fadelong
