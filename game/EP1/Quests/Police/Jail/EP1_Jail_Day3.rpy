...
label EP1_jail_day3_Monica(obj_name, obj_data):
...
label EP1_jail_day3_Bed(obj_name, obj_data):
    if act == "l":
...
label EP1_jail_day3_Cage(obj_name, obj_data):
    if act == "l":
        call EP1_jail_cage()
        call EP1_refresh_scene_fade()
        return
...
label EP1_jail_day3_Cage_Interact:
    if jailDaySceneStage == 0:
        music Groove2_85
        # подходит
        img 5117
