...
#    $ EP1_add_object_to_scene("Teleport_Hostel_1_a", {"type":2, "base":"hostel_edge_1_a_Teleport_Hostel_Edge_a", "click" : "EP1_hostel_edge_1_a_teleport", "actions" : "lw", "zorder" : 11, "b":0.13, "tint":[1.0, 1.0, 0.8]})
    ...
    $ EP1_add_object_to_scene("Teleport_Hostel_1_c", {"type":3, "text" : t_("УЛИЦА"), "rarrow" : "arrow_right_2", "base":"Hostel_Edge_1_a_Teleport_Hostel_Edge_C", "click" : "EP1_hostel_edge_1_a_teleport", "xpos" : 1800, "ypos" : 780, "zorder":15})
    $ EP1_add_object_to_scene("Teleport_Hostel_1_b", {"type":3, "text" : t_("ДРУГАЯ СТОРОНА"), "larrow" : "arrow_down_2", "base":"Hostel_Edge_1_a_Teleport_Hostel_Edge_B", "click" : "EP1_hostel_edge_1_a_teleport", "xpos" : 550, "ypos" : 933, "zorder":15})
