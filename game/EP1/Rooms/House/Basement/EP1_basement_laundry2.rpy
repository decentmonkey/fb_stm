...
label EP1_basement_laundry2:
    ...
    if landryIroningActive == False:
        if laundry2_garbageOnBoard == True:
            $ EP1_add_object_to_scene("Rags1", {"type":2, "base":"Basement_Laundry2_Rags1", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
            $ EP1_add_object_to_scene("Iron_Board", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Default", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
            $ laundryIroningBoardState = "Default"
        else:
            $ EP1_add_object_to_scene("Iron_Board_After_Iron", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Clean", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
            $ EP1_add_object_to_scene("Garbage", {"type":2, "base":"Basement_Laundry2_Garbage_Empty_Garbage", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
            $ EP1_add_object_to_scene("Garbage_Iron", {"type":2, "base":"Basement_Laundry2_Garbage_Empty_Garbage_Iron", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
            $ laundryIroningBoardState = "Empty_Garbage"
    else:
        if laundry2_garbageOnBoard == True:
            $ laundryIroningBoardState = "Default"
            $ EP1_add_object_to_scene("Rags1", {"type":2, "base":"Basement_Laundry2_Rags1", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
            $ EP1_add_object_to_scene("Iron_Board", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Default", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
        else:
            if laundry2_dressIroned == False:
                if laundry2_ironOnBoard == False and laundry2_dressOnBoard == False:
                    $ laundryIroningBoardState = "Clean"
                    $ EP1_add_object_to_scene("Iron_Board", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Clean", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
                    $ EP1_add_object_to_scene("Garbage", {"type":2, "base":"Basement_Laundry2_Garbage_Clean", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
                if laundry2_ironOnBoard == False and laundry2_dressOnBoard == True:
                    $ laundryIroningBoardState = "Dress"
                    $ EP1_add_object_to_scene("Dress", {"type":2, "base":"Basement_Laundry2_Item_Dress", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
                    $ EP1_add_object_to_scene("Iron_Board", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Dress", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
                    $ EP1_add_object_to_scene("Garbage", {"type":2, "base":"Basement_Laundry2_Garbage_Clean", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
                if laundry2_ironOnBoard == True and laundry2_dressOnBoard == False:
                    $ laundryIroningBoardState = "Iron"
                    $ EP1_add_object_to_scene("Iron", {"type":2, "base":"Basement_Laundry2_Item_Iron", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
                    $ EP1_add_object_to_scene("Iron_Board", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Iron", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
                    $ EP1_add_object_to_scene("Garbage", {"type":2, "base":"Basement_Laundry2_Garbage_Clean", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
                if laundry2_ironOnBoard == True and laundry2_dressOnBoard == True:
                    $ laundryIroningBoardState = "Dress_and_Iron"
                    $ EP1_subst_to_object("Teleport_Basement_Laundry", "basement_laundry2_noexit")
                    $ EP1_add_object_to_scene("Iron_Board_Full", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Full", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
                    $ EP1_add_object_to_scene("Garbage", {"type":2, "base":"Basement_Laundry2_Garbage_Clean", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
            else:
                $ EP1_subst_to_object("Teleport_Basement_Laundry", False)
                $ laundryIroningBoardState = "Dress_Ironed"
                $ EP1_add_object_to_scene("Dress_Ironed", {"type":2, "base":"Basement_Laundry2_Item_Dress_Ironed", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
                $ EP1_add_object_to_scene("Iron_Board_After_Iron", {"type":2, "base":"Basement_Laundry2_Ironing_Board_Dress_Ironed", "click" : "EP1_basement_laundry2_environment", "actions" : "lh", "zorder" : 0})
                $ EP1_add_object_to_scene("Garbage", {"type":2, "base":"Basement_Laundry2_Garbage_Empty_Garbage", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
                $ EP1_add_object_to_scene("Garbage_Iron", {"type":2, "base":"Basement_Laundry2_Garbage_Empty_Garbage_Iron", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
...
#    $ EP1_add_object_to_scene("Clothes_Pin", {"type":2, "base":"Basement_Laundry_Clothes_Pin", "click" : "EP1_basement_laundry_environment", "actions" : "l", "zorder" : 0})
    ...
    $ EP1_add_object_to_scene("Clothes_Pin", {"type":2, "base":"Basement_Laundry2_Clothes_Pin", "click" : "EP1_basement_laundry_environment", "actions" : "l", "zorder" : 2})
    $ EP1_add_object_to_scene("Accessories1", {"type":2, "base":"Basement_Laundry2_Accessories1", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Detergents", {"type":2, "base":"Basement_Laundry2_Detergents", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Towels", {"type":2, "base":"Basement_Laundry2_Towels", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Small_Boxes", {"type":2, "base":"Basement_Laundry2_Small_Boxes", "click" : "EP1_basement_laundry2_environment", "actions" : "l", "zorder" : 1})


    $ EP1_add_object_to_scene("Teleport_Box1", {"type":2, "base":"Basement_Laundry2_Box1", "click" : "EP1_basement_laundry2_teleport", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Teleport_Box2", {"type":2, "base":"Basement_Laundry2_Box2", "click" : "EP1_basement_laundry2_teleport", "actions" : "l", "zorder" : 0})

    $ EP1_add_object_to_scene("Teleport_Basement_Laundry", {"type":3, "text" : t_("НАЗАД"), "larrow" : "arrow_down_2", "base":"Screen_Down_Arrow", "click" : "EP1_basement_laundry2_teleport", "xpos" : 510, "ypos" : 956, "zorder":11})

    return


label EP1_basement_laundry2_teleport(obj_name, obj_data):
    ...
    if obj_name == "Teleport_Box1":
        call EP1_change_scene("basement_laundry2_box1", "Fade", "desk_open")
        return
    if obj_name == "Teleport_Box2":
        call EP1_change_scene("basement_laundry2_box2", "Fade", "desk_open")
        return
    return

label EP1_basement_laundry2_environment(obj_name, obj_data):
    ...
    if landryIroningActive == True:
        ...
        if obj_name == "Iron_Board_Full":
            ...
            if obj_data["action"] == "h":
                ...
                sound snd_iron_garbage
                $ EP1_autorun_to_object("basement_laundry2", "basement_laundry2_dress_ironed")
        ...
        if obj_name == "Dress_Ironed":
            ...
            if obj_data["action"] == "h":
                ...
                $ scene_transition = "Fade"
                $ EP1_autorun_to_object("basement_laundry2", "basement_laundry2_iron_taked")
...
label EP1_Iron_Board_use_crumpled_dress:
    if laundry2_garbageOnBoard != False:
        m "Мне надо убрать этот хлам с гладильной доски."
        "Я не могу гладить когда на доске что-то лежит!"
        return
...
label EP1_basement_laundry2_noexit(obj_name, obj_data):
    m "Я не уйду пока не поглажу это платье!!"
    return



label EP1_basement_laundry2_dress_ironed:
    m "Ай!!
    Я обожглась!!!"
...
label EP1_basement_laundry2_iron_taked:
