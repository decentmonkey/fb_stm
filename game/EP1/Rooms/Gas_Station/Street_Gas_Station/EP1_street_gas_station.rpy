...
label EP1_street_gas_station:
    ...
    if bFredFollowingMonica == True:
        ...
        $ EP1_add_object_to_scene("Driver", {"type":2, "base":"Street_Gas_Station_Driver", "click" : "EP1_street_gas_station_environment", "actions" : "lt", "zorder" : 5, "icon_t":"/Icons/talk" + res.suffix +".png", "b":0.2, "s":1.3, "tint":[1.0, 1.0, 0.8]})
        $ EP1_add_object_to_scene("Car", {"type":2, "base":"Street_Gas_Station_Car", "click" : "EP1_street_gas_station_environment", "actions" : "l", "zorder" : 0})
        $ EP1_add_object_to_scene("Monica", {"type":2, "base":"Street_Gas_Station_Driver_Monica_" + cloth + day_suffix, "click" : "EP1_street_gas_station_environment", "actions" : "l", "zorder" : 10})
    else:
        $ scene_image = "scene_Street_Gas_Station_Monica_" + cloth + day_suffix
        $ EP1_add_object_to_scene("Monica", {"type":2, "base":"Street_Gas_Station_Monica_" + cloth + day_suffix, "click" : "EP1_street_gas_station_environment", "actions" : "l", "zorder" : 15})

    $ EP1_add_object_to_scene("Fuel1", {"type":2, "base":"Street_Gas_Station_Fuel1", "click" : "EP1_street_gas_station_environment", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Fuel2", {"type":2, "base":"Street_Gas_Station_Fuel2", "click" : "EP1_street_gas_station_environment", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Logo", {"type":2, "base":"Street_Gas_Station_Logo", "click" : "EP1_street_gas_station_environment", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Station_Building", {"type":2, "base":"Street_Gas_Station_Station_Building", "click" : "EP1_street_gas_station_environment", "actions" : "l", "zorder" : 0})
    $ EP1_add_object_to_scene("Teleport_Inside", {"type":2, "base":"Street_Gas_Station_Teleport_Inside", "click" : "EP1_street_gas_station_teleport", "actions" : "lw", "zorder" : 1})
    return
#                            $ brightness_adjustment = 0.1
#                            $ saturation_adjustment = 1.07
#                            $ contrast_adjustment = 1.3

label EP1_street_gas_station_teleport(obj_name, obj_data):
    if obj_name == "Teleport_Inside":
        ...
        if obj_data["action"] == "w":
            ...
            return
    return
label EP1_street_gas_station_environment(obj_name, obj_data):
    if obj_name == "Monica":
