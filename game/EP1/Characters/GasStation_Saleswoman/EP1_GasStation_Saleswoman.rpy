label EP1_gas_saleswoman_scene1: #начало, фоткает себя и общается с парнем, лаская себя
    ...
    if obj_data["action"] == "t":
        $ EP1_autorun_to_object("gas_station_view_door", "gas_saleswoman_monica_comment1_2")
    else:
        $ EP1_autorun_to_object("gas_station_view_door", "gas_saleswoman_monica_comment1")
    music casualMusic
...
label EP1_gas_saleswoman_scene1_2:
    music Loved_up
    img 4155
    with fadelong
    ...
    menu:
        ...
        "А что у тебя еще есть?":
            jump EP1_gas_saleswoman_scene1_2_sub1
    img 4167
...
label EP1_gas_saleswoman_scene1_2_sub1:
    img 4171
...
label EP1_gas_saleswoman_scene2: #продавщица испуганно прерывается криком из зала
    call EP1_gas_saleswoman_scene1_2()
    img 4183
...
label EP1_gas_saleswoman_scene1_1: #сцена когда разбивается бутылка
    #jump EP1_testlabel1
    call EP1_gas_saleswoman_scene1_2()
    if _return == False:
    ...
    menu:
        ...
        "Я все увидел что хотел! Кристиночка, мне пора!":
            jump EP1_gas_saleswoman_scene1_1_end
    gas_boyfriend "Да, очень хочу!"
    img 4194
    saleswoman "Хорошо, милый...
...
label EP1_gas_saleswoman_scene1_1_end:
    music Power_Bots_Loop
    sound snd_bottle_break
    w
    img 4183
...
label EP1_gas_saleswoman_dialogue1:
...
label EP1_gas_saleswoman_scene3: #разбивается бутылка
    call EP1_gas_saleswoman_scene1_1()
    music Funk_Soul1
    call EP1_bitch(7, "gas_saleswoman_decision")
    ...
    menu:
        "Обвинить во всем кассиршу":
            call EP1_bitch(10, "gas_station_monicalied")
            $ gasStationMonicaLied = True
        "Согласиться на возмещение ущерба":
            call EP1_bitch(-5, "gas_station_monicalied")
...
label EP1_gas_salewoman_sorry_dialogue:
#    img Gas_Station_Monica_OilTrader_8
...
label EP1_gas_saleswoman_monica_comment1:
    m "Или мне просто показалось?..."
    return
label EP1_gas_saleswoman_monica_comment1_2:
    m "Или мне просто показалось?..."
