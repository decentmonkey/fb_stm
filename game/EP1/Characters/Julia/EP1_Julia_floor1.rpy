...
label EP1_julia_interact(obj_name, obj_data):
    if scene_name == "floor1":
        if day == 1 and day_time == "evening":
            call EP1_julia_day1_evening(obj_name, obj_data)
            return
        if day == 2 and day_time == "day":
            call EP1_julia_day2_day(obj_name, obj_data)
            return
        if day == 2 and day_time == "evening":
            call EP1_julia_day2_evening(obj_name, obj_data)
            return
        if day == 3 and day_time == "day":
            call EP1_julia_day3_day(obj_name, obj_data)
            return


        if julia_monica_revenge_in_progress == True:
            jump EP1_floor2_julia_monica_revenge_julia_punish2
        if juliaSeen == False:
        ...
        if juliaSeen == True:
            call EP1_julia_interact3(obj_name, obj_data)

    if scene_name == "kitchen":
        call EP1_julia_interact2(obj_name, obj_data)
