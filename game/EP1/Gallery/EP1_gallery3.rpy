...
label gallery_4182: #начало, фоткает себя и общается с парнем, лаская себя
...
#label gas_saleswoman_scene1_2:
    ...
    menu:
        ...
        "А что у тебя еще есть?":
            jump gallery_gas_saleswoman_scene1_2_sub1
    img 4167
    ...
    label gallery_gas_saleswoman_scene1_2_sub1:
    img 4171
